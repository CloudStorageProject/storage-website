...
export default class RegistrationPage extends React.Component {
    ...
    constructor(props) {
        ...
        this.checkIndexes = getUniqueRandomIntArr(3, 0, 23);
    }
    ...
    render() {
        return (
            ...
            (this.state.registrationStage === 2 && <RegistrationPhrasesConfirm userData={this.userData} secretPhrases={this.secrets.mnemonic} keyPair={{ publicKey: this.secrets.publicKey, privateKey: this.secrets.privateKey }} checkIndexes={this.checkIndexes} randomizeIndexes={this.reRandomizeCheckIndexes.bind(this)} previousStage={this.previousStage.bind(this)} />)
        );
    }
}